...
int main(void)
{
	...
	len2 =  printf("%s\n", "123 ABC \t ^%");
	printf("Printf Length: %d | _printf Length: %d\n", len2, len1);
	len1 = _printf("A long string: %s", "Lorem ipsum, i've forgotten sha but i need a very long string to make sure this thing works");
	len2 = printf("A long string: %s", "Lorem ipsum, i've forgotten sha but i need a very long string to make sure this thing works");
	printf("Printf Length: %d | _printf Length: %d\n", len2, len1);
